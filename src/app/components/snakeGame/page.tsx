      ...
      overflow-hidden inline-block relative">
        ...
        >
          ...
          {!isLost && countDown > 0 ? (
            ...
            m-0 p-3 min-w-[120] text-sm leading-5 text-center
            text-white bg-green-700
            border shadow-[#4B7F52] rounded
        ...
        {isLost && (
          <div id="gameOverlay" className="
          w-full h-full p-5 border-4
          bg-slate-400 bg-opacity-50 backdrop-blur-sm
          flex flex-col items-center content-center
          flex-wrap top-0 left-0 absolute ">
